...
const listeDefinitionsArrayJS = [
    "Cette méthode est utilisée afin de fusionner deux ou plusieurs tableaux en les concaténant. Elle ne modifie pas les tableaux existants, elle renvoie un nouveau tableau qui est le résultat de l'opération",
    ...
    "Cette méthode remplit tous les éléments d'un tableau entre deux index avec une valeur statique. La valeur de l'index de fin n'est pas incluse. Cette méthode renvoie le tableau modifié.",
    "Cette méthode crée et retourne un nouveau tableau contenant tous les éléments du tableau d'origine qui remplissent une condition déterminée par la fonction callback.",
    ...
    "Cette méthode renvoie un nouvel objet Array Iterator qui contient les clefs pour chaque indice du tableau.",
